...
class TemplateReportGenerator(BaseReportGenerator):
    ...
    def _src_path_stats(self, src_path):
        ...
        return {
            ...
            'violation_lines': TemplateReportGenerator.combine_adjacent_lines(violation_lines) if self.COMBINE_ADJACENT_LINES else violation_lines,
...
class Flake8ReportGenerator(TemplateReportGenerator):
    """
    Generate a report in flake8 formatting.
    """
    TEMPLATE_NAME = "flake8_coverage_report.txt"
